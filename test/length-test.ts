...
test("Testing the lineTo", function(test) {
  var properties = new SVGPathProperties("m0,0l10,0");
...
test("Testing the H and V", function(test) {
  var properties = new SVGPathProperties("m0,0h10");
...
test("Testing z and Z", function(test) {
  var properties = new SVGPathProperties("m0,0h10z");
...
test("Testing Cubic Bézier", function(test) {
  //C & c
  var properties = new SVGPathProperties("M100,25C10,90,110,100,150,195");
...
test("Testing Quadratic Bézier", function(test) {
  //Q & q
  var properties = new SVGPathProperties("M200,300 Q400,50 600,300");
...
test("Testing Arcs", function(test) {
  //A & a
  var properties = new SVGPathProperties("M50,20A50,50,0,0,0,150,20");
