...
tape("Testing Arcs", function(test) {
  //A & a
  var properties = path.svgPathProperties("M50,20A50,50,0,0,0,150,20");
  test.inDelta(properties.getTotalLength(),  157.1, 0.1);

  properties = path.svgPathProperties("M50,20A50,50,0,0,0,150,20Z");
  test.inDelta(properties.getTotalLength(),  257.1, 0.1);

  properties = path.svgPathProperties("M50,20a50,50,0,0,0,100,0");
  test.inDelta(properties.getTotalLength(),  157.1, 0.1);
...
tape("Some complex examples", function(test){
  ...
  properties = path.svgPathProperties("M240,100C290,100,240,225,290,200S290,75,340,50S515,100,390,150S215,200,90,150S90,25,140,50S140,175,190,200S190,100,240,100");
