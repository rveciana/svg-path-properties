...
describe('Lengths tests', () => {
  test('Testing LinearPosition directly', function (test) {
    const properties = new LinearPosition(0, 0, 10, 0)
    assert.strictEqual(properties.getTotalLength(), 10, 'Length with m and l')
  })
  ...
  test('Testing the lineTo', function (test) {
    ...
    assert.strictEqual(properties.getTotalLength(), 20, 'Length with M and L')
    properties = new SVGPathProperties('M0,0L10,0m0,0L10,0')
    assert.strictEqual(properties.getTotalLength(), 10, 'Length with m, M and L')

    properties = new SVGPathProperties('M0,0L10,0l10,0')
    assert.strictEqual(properties.getTotalLength(), 20, 'Length with M, l and L')
  })

  test('Testing the H and V', function (test) {
    let properties = new SVGPathProperties('m0,0h10')
    assert.strictEqual(properties.getTotalLength(), 10, 'Length with m and h')

    properties = new SVGPathProperties('M50,0H40')
    assert.strictEqual(properties.getTotalLength(), 10, 'Length with m and H')

    properties = new SVGPathProperties('m0,0v10')
    assert.strictEqual(properties.getTotalLength(), 10, 'Length with m and v')
  ...
  test('Testing z and Z', function (test) {
    ...
    assert.strictEqual(properties.getTotalLength(), 20, 'Length with z')
  ...
  test('Testing Cubic Bézier', function (test) {
    ...
    assert.strictEqual(inDelta(properties.getTotalLength(), 213.8, 0.1), true)
    ...
    assert.strictEqual(inDelta(properties.getTotalLength(), 475.746, 0.1), true)
    ...
    assert.strictEqual(inDelta(properties.getTotalLength(), 327.9618, 0.1), true)
  ...
  test('Testing Quadratic Bézier', function (test) {
    ...
    assert.strictEqual(inDelta(properties.getTotalLength(), 487.77, 0.1), true)
    ...
    assert.strictEqual(inDelta(properties.getTotalLength(), 376.84, 0.1), true)
    ...
    assert.strictEqual(inDelta(properties.getTotalLength(), 565.26, 0.1), true)

    // T & t without previous values
    properties = new SVGPathProperties('M0,100 T200,100')
    assert.strictEqual(inDelta(properties.getTotalLength(), 200, 0.1), true)

    properties = new SVGPathProperties('M0,100 t200,100')
    assert.strictEqual(inDelta(properties.getTotalLength(), 223.606, 0.1), true)
  })

  test('Testing Arcs', function (test) {
    // A & a
    let properties = new SVGPathProperties('M50,20A50,50,0,0,0,150,20')
    assert.strictEqual(inDelta(properties.getTotalLength(), 157.1, 0.1), true)

    properties = new SVGPathProperties('M50,20A50,50,0,0,0,150,20Z')
    assert.strictEqual(inDelta(properties.getTotalLength(), 257.1, 0.1), true)
  ...
  test('Some complex examples', function (test) {
    ...
    assert.strictEqual(inDelta(properties.getTotalLength(), 498.031, 0.1), true)
    ...
    assert.strictEqual(inDelta(properties.getTotalLength(), 1329.45, 0.1), true)
    properties = new SVGPathProperties(
    ...
    assert.strictEqual(inDelta(properties.getTotalLength(), 404, 0.1), true)
    ...
    assert.strictEqual(inDelta(properties.getTotalLength(), 6.71, 0.1), true)
    properties = new SVGPathProperties(
    ...
    assert.strictEqual(inDelta(properties.getTotalLength(), 580, 0.1), true)
    ...
    assert.strictEqual(inDelta(properties.getTotalLength(), 737.13, 0.1), true)

    // https://github.com/rveciana/svg-path-properties/issues/32
    properties = new SVGPathProperties('M270 830 Q270 830 270 830')
    assert.strictEqual(inDelta(properties.getTotalLength(), 0, 0.1), true)
  })
})
